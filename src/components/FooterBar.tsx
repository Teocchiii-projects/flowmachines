...
const FooterBar: React.FC = () => {
    return (
        ...
        >
            <Container>
                <img src={"./src/assets/home/0000018267IM01.jpg"} alt={"asociados"}/>
            </Container>
            <Container maxWidth="lg" sx={{gap:2, mt:2}}>
                    ...
                    <Grid item xs={12} md={8}>
                        ...
                        <Box display="flex" alignItems="flex-start" mb={1}>
                            ...
                            <Typography variant="body2">
                                Dirección: Av. Los Mangos Mz. A Lt. 8-A, Urb. Canto Grande, San Juan de Lurigancho,
                                Lima, Perú
                            </Typography>
                        </Box>
                        ...
                        <Box display="flex" alignItems="center" mb={1}>
                            ...
                            <Typography variant="body2">
                                Email:{" "}
                                <Link href="mailto:flowmach@flowmachperu.com" color="inherit" underline="hover">
